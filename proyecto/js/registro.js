...
async function registrarUsuario() {
    ...
    registroForm.tipo_usuario_id_tipo_usu = document.getElementById('tipo_usuario').value;
    ...
    if (!registroForm.nombre_usu || !registroForm.telefono_usu || !registroForm.tipo_usuario_id_tipo_usu || !registroForm.correo_usu || !registroForm.contrasenia_usu || registroForm.contrasenia_usu !== confirmarContrasenia) {
